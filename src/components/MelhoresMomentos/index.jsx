...
const MelhoresMomentos = () => {
  return (
      <section className="py-8 border-y border-black dark:border-white text-white">
        <div className="flex items-center justify-center gap-1 pb-5 text-black dark:text-white">
